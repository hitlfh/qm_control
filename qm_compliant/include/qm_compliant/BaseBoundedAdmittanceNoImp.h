...
#ifndef SRC_BASEBOUNDEDADMITTANCENOIMP_H
#define SRC_BASEBOUNDEDADMITTANCENOIMP_H
...
class BaseBoundedAdmittanceNoImp {
public:
    BaseBoundedAdmittanceNoImp(const PinocchioInterface &pinocchioInterface, CentroidalModelInfo info,
    ...
    void setTorqueExternal(scalar_t torque) { torque_ext_ = torque;};
...
#endif //SRC_BASEBOUNDEDADMITTANCENOIMP_H
